...
public class WaystoneBlockScreen extends UniversalWaystoneScreen {
    ...
    private final Button configPage = new Button(156, -17, 18, 18, 207, 0) {
        ...
        @Override
        public void setup() {
            this.tooltip = new TranslatableText("fwaystones.config.tooltip.config");
        }
    };
    ...
    public WaystoneBlockScreen(ScreenHandler handler, PlayerInventory inventory, Text title) {
        ...
        buttons.add(new Button(156, -17, 18, 18, 177, 0) {
            ...
            @Override
            public void setup() {
                this.tooltip = new TranslatableText("fwaystones.config.tooltip.back");
            }
        });
        ...
        buttons.add(new Button(8, 103, 13, 13, 177, 54) {
            ...
            @Override
            public void setup() {
                this.tooltip = new TranslatableText("fwaystones.config.tooltip.delete_name");
            }
        });
        ...
        buttons.add(new ToggleableButton(128, 103, 13, 13, 190, 54, 216, 54) {
            @Override
            public void setup() {
                this.tooltip = new TranslatableText("fwaystones.config.tooltip.set_name");
        ...
        buttons.add(new Button(143, 103, 13, 13, 203, 54) {
            ...
            @Override
            public void setup() {
                this.tooltip = new TranslatableText("fwaystones.config.tooltip.randomize_name");
            }
        });
        ...
        buttons.add(new ToggleableButton(8, 48, 17, 17, 212, 0, 195, 0) {
            ...
            public void setup() {
                ...
                this.tooltip = new TranslatableText("fwaystones.config.tooltip.toggle_is_global");
            }
        ...
        buttons.add(new ToggleableButton(8, 11, 13, 13, 177, 54, 190, 54) {
            ...
            public void setup() {
                ...
                this.tooltip = new TranslatableText("fwaystones.config.tooltip.toggle_discovered_view");
            }
        ...
        buttons.add(new ToggleableButton(8, 27, 13, 13, 177, 54, 190, 54) {
            @Override
            public void setup() {
                this.tooltip = new TranslatableText("fwaystones.config.tooltip.toggle_global_view");
        ...
        buttons.add(new Button(30, 48, 17, 17, 229, 0) {
            ...
            @Override
            public void setup() {
                this.tooltip = new TranslatableText("fwaystones.config.tooltip.revoke_ownership");
            }
        });
    }
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        if (page == Page.WAYSTONES) {
            ...
            if (owner == null || "".equals(owner)) {
                owner = new TranslatableText("fwaystones.config.no_owner").getString();
            }
            this.textRenderer.draw(matrices, new TranslatableText("fwaystones.config.owner", owner), this.x + 10, this.y + 75, 0x161616);
    ...
    private void renderButtonText(MatrixStack matrices) {
        this.textRenderer.draw(matrices, new TranslatableText("fwaystones.config.view_discovered"), this.x + 25, this.y + 14, 0x161616);
        this.textRenderer.draw(matrices, new TranslatableText("fwaystones.config.view_global"), this.x + 25, this.y + 30, 0x161616);
    }
