                ...
                if (!blockEntity.isGlobal()) {
                        ...
                        if (!Utils.containsItem(player.getInventory(), discoverItem, discoverAmount)) {
                            player.sendMessage(new TranslatableText(
                                ...
                                new TranslatableText(discoverItem.getTranslationKey()).styled(style ->
                                    style.withColor(TextColor.parse(new TranslatableText("fwaystones.missing_discover_item.arg_color").getString()))
                                )
                            ), false);
                            return ActionResult.FAIL;
                        } else {
                            ...
                            player.sendMessage(new TranslatableText(
                                ...
                                discoverAmount,
                                new TranslatableText(discoverItem.getTranslationKey()).styled(style ->
                                    style.withColor(TextColor.parse(new TranslatableText("fwaystones.discover_item_paid.arg_color").getString()))
                                )
                            ), false);
                        }
                    }
                    player.sendMessage(new TranslatableText(
                        ...
                        new LiteralText(blockEntity.getWaystoneName()).styled(style ->
                            style.withColor(TextColor.parse(new TranslatableText("fwaystones.discover_waystone.arg_color").getString()))
                        )
                    ), false);
                }
