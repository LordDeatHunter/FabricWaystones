...
public class WaystonesEventManager {
    ...
    public static void registerEvents() {
        ...
        CommandRegistrationCallback.EVENT.register((dispatcher, dedicated) -> dispatcher.register(CommandManager.literal("fabricwaystones")
            .then(CommandManager.literal("reload")
                ...
                .executes(context -> {
                    ...
                    if (player != null) {
                        player.sendMessage(new LiteralText("§6[§eFabric Waystones§6] §3has successfully reloaded!"), false);
                    }
                    return 1;
                })
            )
            .then(CommandManager.literal("delete")
                ...
                .executes(context -> {
                    ...
                    player.sendMessage(new LiteralText("§6[§eFabric Waystones§6] §3Removed all waystones from " + dimension + "!"), false);
                    return 1;
                })
            )
            ...
            .then(CommandManager.literal("forget_all")
                .executes(context -> {
                    ...
                    player.sendMessage(new LiteralText("§6[§eFabric Waystones§6] §3All waystones have been forgotten!"), false);
                    return 1;
                })
                .then(CommandManager.argument("player", EntityArgumentType.player())
                    ...
                    .executes(context -> {
                        ...
                        player.sendMessage(new LiteralText("§6[§eFabric Waystones§6] §3All waystones have been forgotten for " + target.getName() + "!"), false);
                        return 1;
                    })
                )
            )
