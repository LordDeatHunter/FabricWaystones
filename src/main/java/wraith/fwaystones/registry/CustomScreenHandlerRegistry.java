...
public final class CustomScreenHandlerRegistry {
    ...
    public static void registerScreenHandlers() {
        WAYSTONE_SCREEN = Registry.register(Registries.SCREEN_HANDLER, Utils.ID("waystone"), new ExtendedScreenHandlerType<>(WaystoneBlockScreenHandler::new));
        POCKET_WORMHOLE_SCREEN = Registry.register(Registries.SCREEN_HANDLER, Utils.ID("pocket_wormhole"), new ScreenHandlerType<>(PocketWormholeScreenHandler::new));
        ABYSS_SCREEN_HANDLER = Registry.register(Registries.SCREEN_HANDLER, Utils.ID("abyss"), new ScreenHandlerType<>(AbyssScreenHandler::new));
    }
