...
public final class ItemRegistry {
    ...
    public static void init() {
        ...
        // Items
        registerItem(new Item(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of("fwaystones", "pocket_wormhole"))).maxCount(1).fireproof().translationKey("item.fwaystones.pocket_wormhole")), RegistryKey.of(RegistryKeys.ITEM, Identifier.of("fwaystones", "pocket_wormhole")));
        registerItem(new Item(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of("fwaystones", "abyss_watcher"))).maxCount(4).fireproof().translationKey("item.fwaystones.abyss_watcher")), RegistryKey.of(RegistryKeys.ITEM, Identifier.of("fwaystones", "abyss_watcher")));
        registerItem(new Item(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of("fwaystones", "waystone_scroll"))).maxCount(1).translationKey("item.fwaystones.empty_scroll")), RegistryKey.of(RegistryKeys.ITEM, Identifier.of("fwaystones", "waystone_scroll")));
        registerItem(new Item(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of("fwaystones", "local_void"))).maxCount(1).translationKey("item.fwaystones.local_void")), RegistryKey.of(RegistryKeys.ITEM, Identifier.of("fwaystones", "local_void")));
        registerItem(new Item(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of("fwaystones", "void_totem"))).maxCount(1).translationKey("item.fwaystones.void_totem")), RegistryKey.of(RegistryKeys.ITEM, Identifier.of("fwaystones", "void_totem")));
        registerItem(new Item(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of("fwaystones", "scroll_of_infinite_knowledge"))).maxCount(1).fireproof().translationKey("item.fwaystones.scroll_of_infinite_knowledge")), RegistryKey.of(RegistryKeys.ITEM, Identifier.of("fwaystones", "scroll_of_infinite_knowledge")));
        registerItem(new Item(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of("fwaystones", "waystone_debugger"))).maxCount(1).fireproof().translationKey("item.fwaystones.waystone_debugger")), RegistryKey.of(RegistryKeys.ITEM, Identifier.of("fwaystones", "waystone_debugger")));
