...
public final class ItemRegistry {
    ...
    static {
        ...
        ITEMS.put("nether_brick_waystone", new WaystoneItem(BlockRegistry.NETHER_BRICK_WAYSTONE, new Item.Settings().group(CustomItemGroup.WAYSTONE_GROUP)));
        ITEMS.put("red_nether_brick_waystone", new WaystoneItem(BlockRegistry.RED_NETHER_BRICK_WAYSTONE, new Item.Settings().group(CustomItemGroup.WAYSTONE_GROUP)));
