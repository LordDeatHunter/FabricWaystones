...
public final class RepurposedStructuresCompat {
    ...
    public static void init() {
        ...
        StructurePiecesBehavior.addRequiredVillagePiece("village_crimson", new Identifier("waystones:village_waystone"), RepurposedStructures.RSAllConfig.RSVillagesConfig.size.crimsonVillageSize);
        ...
        StructurePiecesBehavior.addRequiredVillagePiece("village_warped", new Identifier("waystones:village_waystone"), RepurposedStructures.RSAllConfig.RSVillagesConfig.size.warpedVillageSize);
    }
    ...
    static {
        ...
        REPURPOSED_STRUCTURES_VILLAGES.put(new Identifier("repurposed_structures", "villages/crimson/houses"), new Identifier("waystones:village_waystone"));
        ...
        REPURPOSED_STRUCTURES_VILLAGES.put(new Identifier("repurposed_structures", "villages/warped/houses"), new Identifier("waystones:village_waystone"));
