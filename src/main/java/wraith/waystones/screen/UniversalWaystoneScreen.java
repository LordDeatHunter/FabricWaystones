...
public class UniversalWaystoneScreen extends HandledScreen<ScreenHandler> {
    ...
    private void renderWaystoneAmount(MatrixStack matrices, int x, int y) {
        this.textRenderer.draw(matrices, new TranslatableText("waystones.gui.displayed_waystones", new TranslatableText("waystones.gui.displayed_waystones.arg_color").append(String.valueOf(this.getDiscoveredCount()))), x, y, 0x161616);
    }
