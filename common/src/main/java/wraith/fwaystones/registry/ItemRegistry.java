...
public final class ItemRegistry {
	...
	// ------------------------------------------------------------------------------------------------------
	public static final RegistrySupplier<Item> POCKET_WORMHOLE = ITEM_REGISTRY.register("pocket_wormhole", ()->new PocketWormholeItem(new Item.Properties().stacksTo(1).fireResistant()));
	public static final RegistrySupplier<Item> ABYSS_WATCHER = ITEM_REGISTRY.register("abyss_watcher", ()->new AbyssWatcherItem(new Item.Properties().stacksTo(4).fireResistant()));
	public static final RegistrySupplier<Item> WAYSTONE_SCROLL = ITEM_REGISTRY.register("waystone_scroll", ()->new WaystoneScrollItem(new Item.Properties().stacksTo(1)));
	public static final RegistrySupplier<Item> LOCAL_VOID = ITEM_REGISTRY.register("local_void", ()->new LocalVoidItem(new Item.Properties().stacksTo(1)));
	public static final RegistrySupplier<Item> VOID_TOTEM = ITEM_REGISTRY.register("void_totem", ()->new VoidTotem(new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
	public static final RegistrySupplier<Item> SCROLL_OF_INFINITE_KNOWLEDGE = ITEM_REGISTRY.register("scroll_of_infinite_knowledge", ()->new ScrollOfInfiniteKnowledgeItem(new Item.Properties().stacksTo(1).fireResistant()));
	public static final RegistrySupplier<Item> WAYSTONE_DEBUGGER = ITEM_REGISTRY.register("waystone_debugger", ()->new WaystoneDebuggerItem(new Item.Properties().stacksTo(1).fireResistant().rarity(Rarity.EPIC)));
	//-------------------------------------------------------------------------------------------------------
	private static RegistrySupplier<Item> registerWaystone(RegistrySupplier<Block> block, String name) {
		RegistrySupplier<Item> toReturn = ITEM_REGISTRY.register(name, ()->new WaystoneItem(block.get(), new Item.Properties()));
		//CreativeTabRegistry.append(WAYSTONE_GROUP, toReturn);
		return toReturn;
	}
}
